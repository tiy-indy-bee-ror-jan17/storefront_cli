...
puts "#{virg.street}, #{virg.city}, #{virg.state}, #{virg.zip}"
...
# What item was ordered most often? Grossed the most money?
 most_order = Item.select("items.title as title, items.price as price, sum('quantity') as number").joins(:orders).group("orders.item_id").order('number')
 puts most_order
